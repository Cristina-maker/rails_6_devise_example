...
job = Job.create(name: "LUCRATOR IN CURATENIE", description: "Fundatia HAO Romania selecteaza tineri
  ...
  Bucuresti, Timisoara, Cluj", type: "parttime")
